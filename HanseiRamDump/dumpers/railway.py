...
def dump_railway(dump_path, rpm, memory, debug_info):
    ...
    with open(ee_status_file_name, 'w') as ee_status_file:
        ...
        print('\n\n ~~ Total RAIL: %d ~~' % num_rails, file=ee_status_file)
        for rail_num in range(num_rails):
            try:
                ...
                print('\t\tlevel:                %s' % rail.current_active.vol_level, file=ee_status_file)
                ...
                print('\t\tlevel:                %s' % rail.unconstrained_target.vol_level, file=ee_status_file)
                ...
                print('\t\tlevel:                %s' % rail.constrained_target.vol_level, file=ee_status_file)
                ...
                while(voter.address != 0):
                    try:
                        ...
                        print('%svoltage_Level:           %s' % (tabs, voter.voltage_level), file=ee_status_file)
